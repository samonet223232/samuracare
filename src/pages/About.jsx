  ...
  return (
    <main className="pt-24">
          ...
          <FadeInSection>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-neutral-800 text-white rounded-2xl p-6 shadow-xl max-w-[200px]">
                <p className="font-serif text-3xl font-semibold text-blush-300">سارة</p>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeInSection>
            <div className="text-center mb-14">
              <p className="text-xs font-sans tracking-widest text-blush-400 mb-3">ما نؤمن به</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <FadeInSection>
          <div className="text-center mb-14">
            <p className="text-xs font-sans tracking-widest text-blush-400 mb-3">الرحلة</p>
          ...
          {timeline.map((item, i) => (
            <FadeInSection key={item.year} delay={i * 80}>
              <div className="mb-8 relative">
                <div className="absolute -right-[2.6rem] w-5 h-5 bg-blush-300 rounded-full border-4 border-cream-50" />
                <p className="text-xs font-sans font-medium text-blush-400 tracking-widest mb-1">{item.year}</p>
      ...
      <FadeInSection>
        <section className="bg-neutral-800 py-20 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            <p className="text-xs font-sans tracking-widest text-blush-300 mb-4">انضمي إلى الرحلة</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/articles" className="bg-blush-400 text-white px-7 py-3.5 rounded-full text-sm font-sans font-medium hover:bg-blush-500 transition-colors">
                اقرأي المقالات
              </Link>
              <Link to="/guide" className="border border-neutral-500 text-neutral-200 px-7 py-3.5 rounded-full text-sm font-sans font-medium hover:border-blush-300 hover:text-blush-300 transition-colors flex items-center gap-2 justify-center">
