...
import { FileText, Plus, X, GripVertical, Eye, EyeOff, Pencil, Trash2, ChevronUp, ChevronDown } from 'lucide-react';

const emptyForm = { title: '', slug: '', content: '', showInHeader: true, order: 0, icon: 'FileText' };
...
export default function PagesManager() {
  ...
  const openNew = () => {
    setForm({ ...emptyForm, order: pages.length });
    setEditingId(null);
    setShowForm(true);
  };
              ...
              <form onSubmit={handleSave} className="p-6 space-y-5">
                ...
                <div className="flex justify-end gap-3 pt-2 border-t border-neutral-100">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl text-sm font-medium text-neutral-600 hover:bg-neutral-100 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
